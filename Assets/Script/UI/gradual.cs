...
public class gradual : MonoBehaviour {
    ...
    public void setColor(int red_end1, int red_end2, int yellow_end1, int yellow_end2, int eyan_end) {
        ...
        float _time = 0.05f;
        this.red_end1 = (int)Mathf.Lerp(this.red_end1, red_end1 < 20 ? 20 : red_end1, _time);
        this.red_end2 = (int)Mathf.Lerp(this.red_end2, red_end2, _time);
        this.yellow_end1 = (int)Mathf.Lerp(this.yellow_end1, yellow_end1, _time);
        this.yellow_end2 = (int)Mathf.Lerp(this.yellow_end2, yellow_end2, _time);
        this.eyan_end = (int)Mathf.Lerp(this.eyan_end, eyan_end, _time);
    }
}
